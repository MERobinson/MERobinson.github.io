...
```{r rstudio_interface, fig.cap='The RStudio interface', out.width='90%', fig.asp=1, fig.align='center', echo=F}
...
```{r, eval=FALSE, message=FALSE, warning=FALSE}
animal_noises <- list("moo","baa","quack")
```
...
Sweet! There's lots of functions out there but you always call them in the same way - by typing the function name followed by curly brackets/parantheses. 
